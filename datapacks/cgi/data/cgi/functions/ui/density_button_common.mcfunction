...
title @a actionbar [{"text":"[","color":"gray"},{"text":"CGI","color":"gold"},{"text":"] ","color":"gray"},{"text":" Map Density set to ","color":"dark_purple"},{"score":{"objective":"data","name":"structureCount"},"color":"light_purple"},{"text":" objects","color":"dark_purple"}]
